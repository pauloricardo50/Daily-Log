...
function date(){
	...
	document.getElementById('data').innerHTML= "<span class ='tile_info'>" + dia+" "+meses[mes]+" "+ ano +"</span>";
	setTimeout('date()',500);
}
