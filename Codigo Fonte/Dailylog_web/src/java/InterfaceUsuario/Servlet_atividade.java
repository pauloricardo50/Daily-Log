 ...
 * @author jardielma
 */
public class Servlet_atividade extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           atividade = new Atividade();     
            ...
            html += "<div class=\"right_col\" role=\"main\" style=\"min-height: 1775px;\">\n" +
                    ...
                    tabela_avisos;
        html +=
                "            <form action=\"servlet_atividade\" method=\"POST\">\n" +
                "                <div class=\"row\">\n" +
                "                    <div class=\"col-xs-2\">\n" +
                ...
                "                        <input type=\"textbox\" class=\"form-control form-control-sm\" name=\"descricao\" placeholder=\"descricao\" value=\""+descricao+"\">\n" +                             
                "                          </div>\n" +
                "                </div>\n" +
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        id_atividade = request.getParameter("idatividade");
        ...
        atividade.setIdUsuario(Integer.parseInt(request.getParameter("id_usuario")));
        atividade.setData(request.getParameter("data"));
        atividade.setHorarioInicial(request.getParameter("inicio"));
        atividade.setHorarioFinal(request.getParameter("fim"));
        atividade.setIdExpediente(Integer.parseInt(request.getParameter("expediente")));
        atividade.setIdSubCategoria(Integer.parseInt(request.getParameter("subCategoria")));
        //salva
        atividade.salvar();
        //redireciona
        response.sendRedirect("./servlet_listaAtividades?id_user="+atividade.getIdUsuario());
        //processRequest(request, response);
    }
    ...
    public String listarExpediente(Usuario user, int id_expediente){
        String retorno = "<select name=\"expediente\" class=\"form-control form-control-sm\" >\n";
    ...
    public String listarSubCategorias(int idSubCategorias){
        String retorno = "<select name=\"subCategoria\" class=\"form-control form-control-sm\" >\n";
    ...
    public String listarParticipacaoAtividades(Atividade atividade){
        ...
        for(ParticipacaoAtividade linha:lista){
            ...
            retorno+="<tr>\n"
                    ...
                    + "<td><a href=\"./servlet_participacaoAtividade?id_atividade="+linha.getIdAtividade()+ "&id_user="+user.getId()+"&id_participacaoAtividade="+linha.getId()+"\" class=\"button\">Editar</a></td>\n"
                    + "<td><a href=\"./servlet_excluirParticipacaoAtividade?id_atividade="+linha.getIdAtividade()+ "&id_user="+user.getId()+"&id_participacaoAtividade="+linha.getId()+"\" class=\"button\">Excluir</a></td>\n"
                    + "</tr>";
        }
        retorno+="<tr>\n"
                    + "</tr>"
    ...
    public String listarParticipacaoAtividades(Atividade atividade,boolean template){
        ...
        for(ParticipacaoAtividade linha:lista){
            ...
            retorno+="<tr>\n"
                    ...
                    + "<td>"+usuarioParticipacao.getId()+"</td>\n"
                    + "<td>"+usuarioParticipacao.getNome()+"</td>\n"                    
                    + "<td><a href=\"./servlet_participacaoAtividade?id_atividade="+linha.getIdAtividade()+ "&id_user="+user.getId()+"&id_participacaoAtividade="+linha.getId()+"\" >Editar</a></td>\n"
                    + "<td><a href=\"./servlet_excluirParticipacaoAtividade?id_atividade="+linha.getIdAtividade()+ "&id_user="+user.getId()+"&id_participacaoAtividade="+linha.getId()+"\" >Excluir</a></td>\n"
                    + "</tr>";
        }
//                retorno+="<tr>\n"
